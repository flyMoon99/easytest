        ...
        <form @submit.prevent="handleSubmit" class="space-y-6">
          ...
          <div class="flex items-start">
            ...
            <label for="agree" class="ml-2 block text-sm text-gray-700">
              我已阅读并同意
              <button type="button" class="text-primary-600 hover:text-primary-500">服务条款</button>
              和
              <button type="button" class="text-primary-600 hover:text-primary-500">隐私政策</button>
            </label>
          </div>
